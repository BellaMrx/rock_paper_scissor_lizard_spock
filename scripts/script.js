...
function btnRock() {
	...
	userImageChoice.src = '<i class="fa-solid fa-hand-back-fist"></i>';
	
	//legt die 5 optionen fest
	var optionsR = [
		{
		  text: "Unentschieden",				//
		  icon:  '<i class="fa-solid fa-hand-back-fist"></i>',		   		//option1
		  score: "Draw",						//
		},
		{
		  text: "Computer gewinnt",				//
		  icon:  '<i class="fa-solid fa-hand"></i>',			//option2
		  score: "Lose",						//
		},
		{
		  text: "Du gewinnst",					//
		  icon: '<i class="fa-solid fa-hand-scissors"></i>',			//option3
		  score: "Win",							//
		},
		{
		  text: "Du gewinnst",					//
          icon:  '<i class="fa-solid fa-hand-lizard"></i>',			//option4
		  score: "Win",							//
		},
		{
		  text: "Computer gewinnt",				//
          icon: '<i class="fa-solid fa-hand-spock"></i>',			//option5	
		  score: "Lose",						//
		}
	];
	...
	computerImageResult.src = rndR.icon;		//ausgabe option icon aus optionsR
	
	var computerTextResult = document.querySelector("#textResultDrawLoseWin");
	computerTextResult.src = '<p>' + rndR.text + '</p>';		//ausgabe option text aus optionsR
